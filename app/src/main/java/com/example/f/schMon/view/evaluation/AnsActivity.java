...
//___________________End option menu______________________________________
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Helper.setFont(context, new View[]{Question, Answer, evalutionInfo,
    ...
    void makeAnsModelInputigData() {
        ...
        data.setPerf(Helper.evaluationPerfromCalc(askedET.getText().toString(), ansCorrectET.getText().toString()));
        Log.d(TAG, "Perf Single: " + data.getPerf());
        data.setLocalIDAns(Helper.generateUniqueID("acad-ans"));
    }

    void saveInDB() {

        makeAnsModelInputigData();
        Log.d(TAG,"Performance of individual ans: "+data.perf);
        ...
        String perfAvg = Helper.calcEvlPerfOfASchADate(schID, date);
        Log.d(TAG, perfAvg);
    ...
    private void saveTemporarilyInGlobalList(EvlModelin data) {
        List<EvlModelin> list = App.getEvlList();
