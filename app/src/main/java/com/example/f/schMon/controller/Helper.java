...
//___________________________activity related____________________________________________________________________________________________________________________
        ...
        if (in != null) {
            ...
            if (in instanceof RepMdlin) {
                ...
                if (((RepMdlin) in).getDateReport() != null)
                    info.setDateRep("Date Reported: " + (Helper.dateFormat2(((RepMdlin) in).getDateReport())));
            ...
            /*evaluation*/
                ...
                if (((EvlModelin) in).getDate_report() != null)
                    info.setDateRep("Date Evaluated: " + (Helper.dateFormat2(((EvlModelin) in).getDate_report())));
    ...
    public static RepMdlin fromRepModeltoRepModelin(RepModel repModel) {
        ...
        repMdlin.setAnswer(repModel.getAnswer());
    ...
    public static List<EvlModelin> allQuesWithPrevAnswers(List<EvlModelin> allQues, List<EvlModelin> answered) {
        ...
        notAnswered = Helper.quesNotAnsweredPreviousEvaluation(allQues, answered);
    ...
    public static String calcEvlPerfOfASchADate(String schID, String date) {
        ...
        perfAvg = Helper.calcEvlPerfOfAEvalReport(evlModelinList);
        return perfAvg;
    }
    ...
    public static String calcRepPerformForASch(List<RepMdlin> l) {
        ...
        try {
                ...
                if (r.getAnswer() != null && r.getAnswer().length() > 0) {
                    ...
                    if (r.getAnswer().equals("1")) {
                        ...
                        if (r.getPriority().equals("1"))
                            ...
                            perf = 75;
                    } else if (r.getAnswer().equals("2")) {// when ques is not answered
                        perf = 0;
                    }
                    sum += perf;
            ...
            if (countAnsweredQues != 0) {
                avg = sum / countAnsweredQues;
            } else {
                avg = 0;
            }
    ...
    public static RepMdlin formatReportDataToShowInAns(Context context, RepMdlin data) {
        if (data.getAnswer() != null) {
            if (data.getAnswer().equals("1")) {
                ...
                data.setPriorityExtra("Problem Priority: " + Helper.problemPriorityNumToText(data));
                data.setPriorityColorExtra(Helper.problemPriorityColor(context, data));
                ...
                if (data.getDateTarget() == null)
                    ...
                    data.setDateTargetExtra("Target Date to Solve: " + Helper.dateFormat2(data.getDateTarget()));
            }
        }
        return data;
    }
    ...
    public static boolean isPaymentSyncedThisMonth(Context context) {
        ...
        try {
            ...
            String lastSyncTime = Helper.getTimeOfLastPaymentSync(context);
