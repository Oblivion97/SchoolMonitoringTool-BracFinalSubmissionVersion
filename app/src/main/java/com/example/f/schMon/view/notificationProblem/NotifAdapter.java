...
public class NotifAdapter extends ArrayAdapter<RepMdlin> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Helper.setFont(cntx, new View[]{h.dateTV, h.title, h.schoolName, h.grade, h.description, h.targetD, h.yes, h.no});
        //================ set data in row ================================
        ...
        h.dateTV.setText(Helper.dateFormat2(list.get(position).getDateReport()));
        h.title.setText("Problem: " + Helper.toCamelCase(list.get(position).getQuestion()));
        ...
        h.targetD.setText("Target date to solve: " + Helper.dateFormat2(list.get(position).getDateTarget()));
    ...
    private void updateDBYesChkClick(final int position, View v, final RepMdlin data) {
       ...
       /* data.setNotify("0");
        ...
        updateDB_on_NotifyYesClick(data);*/
        ...
        DatePickerDialog datePicker = new DatePickerDialog(cntx, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int y, int m, int d) {
                ...
                data.setNotify_his("1");
                data.setN_update_date(df1.format(new Date(System.currentTimeMillis())));
                data.setDateSolve(Helper.df1DateFromYearMonthDay(y, m, d));
                updateDB_on_NotifyYesClick(data);
    ...
    public static boolean updateDB_on_NotifyYesClick(RepMdlin r) {
        boolean f;
        List<RepMdlin> repMdlins = new ArrayList<>();
        repMdlins.add(r);
        f = DAO.insertReport(repMdlins, r.getSchID(), r.getDateReport(), r.getGradeID());
        return true;
    }
