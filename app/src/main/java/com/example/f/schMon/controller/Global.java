...
public class Global {
    ...
    public static String timeAttendanceDash = "timeAttendanceDash";
    ...
    // report category preference
    public static String reportCategoryPref="reportCategoryPref";
...
/*================================= Methods =========================================================================================*/
    ...
    public static boolean getUser_Info_from_pref_for_nav_drawer(Context context) {
        ...
        if (userModel.getFirstName() == null && userModel.getMiddleName() == null && userModel.getLastName() == null)
            Global.userFullName = Helper.toCamelCase(Global.getUser_Name(context));
    ...
    public static boolean isPO_userRole(){
        boolean isPO=false;
        //__________ get po info _______________
        UserModel userM;
        SharedPreferences sp = App.getAppContext().getSharedPreferences(Global.preference, Context.MODE_PRIVATE);
        ...
        if(userM.getRoleName().equalsIgnoreCase("PO")
                ||userM.getRoleName().equalsIgnoreCase("PS")){
            isPO=true;
        }
    ...
    public static SQLiteDatabase getDB_with_nativeWay_readable(String dbName) {
        if (sqLiteDB == null)
            sqLiteDB = SQLiteDbHelperNative.getInstance(App.getAppContext(), dbName)
                    .getReadableDatabase();
        return sqLiteDB;
    }
    ...
    public static SQLiteDatabase getDB_with_AssetHelper_readable(String dbName) {
        if (sqLiteDB == null)
            sqLiteDB = SQLiteDbHelper.getInstance(App.getAppContext(), dbName, null, ver)
                    .getReadableDatabase();
        return sqLiteDB;
    }
