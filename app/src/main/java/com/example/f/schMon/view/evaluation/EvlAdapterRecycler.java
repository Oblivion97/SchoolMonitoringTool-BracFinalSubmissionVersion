...
public class EvlAdapterRecycler extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EvlAdapterRecycler(Context context, String schID, String gradeID, String date, String attendance,
                              String openMode, List<EvlModelin> list, boolean isSynced) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder h, final int i) {
        ...
        Helper.setFont(context, new View[]{((VH) h).quesTV, ((VH) h).askTV, ((VH) h).correctTV});
