...
public class TestActivity1 extends AppCompatActivity implements WSResponseListener {
    ...
    public void StringFromFile(View view) {
        String t = Helper.getStringFrom_File_in_Assets(context, "schoolPoWise.txt");
        textView.setText(t);
    }
    ...
    public void onClickSyncStd(View view) {
        Toast.makeText(App.getAppContext(), "not available", Toast.LENGTH_SHORT).show();
    }
    ...
    class RestAPICallThread extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            //  object1 = Sync.syncSchoolTableTen(App.getAppContext(), db, params[0]);
            object = Sync.syncSchoolTableAll(App.getAppContext(), db, params[0]);
            if (object[0] != null)
