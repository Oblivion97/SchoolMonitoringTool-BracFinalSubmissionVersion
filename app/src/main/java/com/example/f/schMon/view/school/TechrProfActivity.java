...
public class TechrProfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Helper.setFont(context, new View[]{techrNmeTxtVw, techrPhnTxtVw, techrGradeTxtVw, techrAdrsTxtVw, noDataTV, teacherEducation});
    ...
    class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (techr != null) {
                ...
                if (techr.tName == null)
                    techrNmeTxtVw.setText(Helper.underscoreToSpacedFormat("Name : Not Available"));
                else
                    techrNmeTxtVw.setText(Helper.underscoreToSpacedFormat(techr.tName));
                ...
                if (techr.address == null)
                    ...
                    techrAdrsTxtVw.setText("Address: " + Helper.toCamelCase(techr.address));
            }
        }
    }
}
