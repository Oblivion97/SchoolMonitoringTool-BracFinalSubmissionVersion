...
//===================================== parcelable ==============================================================
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.localIDQues);
        dest.writeString(this.serverIDAns);
        dest.writeString(this.localIDAns);
        ...
        dest.writeString(this.askedExtra);
        dest.writeString(this.correctExtra);
        dest.writeInt(this.listPosition);
        dest.writeInt(this.quesNo);
        dest.writeInt(this.imgID);
        dest.writeInt(this.ansColor);
    }
    ...
    protected EvlModelin(Parcel in) {
        ...
        this.localIDQues = in.readString();
        this.serverIDAns = in.readString();
        this.localIDAns = in.readString();
        ...
        this.askedExtra = in.readString();
        this.correctExtra = in.readString();
        this.listPosition = in.readInt();
        this.quesNo = in.readInt();
