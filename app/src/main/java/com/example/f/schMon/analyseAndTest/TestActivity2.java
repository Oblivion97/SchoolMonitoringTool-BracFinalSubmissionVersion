...
public class TestActivity2 extends Activity implements WSResponseListener {
    ...
    public void onClickTestBtn(View v) {
      ...
      /*  dates = Helper.getUniqueDateFromATable( DB.acad_perform.table, DB.acad_perform.date_report);
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                s = Helper.lastDates(dates, 5).toString();
                return null;
            }
...
*/
      ...
      /*  textView.setText(DAO2.getAllExistingProblemsFromReport().size()+"\n\n"+
                DAO2.getAllExistingProblemsFromReport().toString());*/

/*
        List<String> datesAll = Helper.getUniqueDateFromATable(DB.admin_perform.table, DB.admin_perform.date_report);


        dates = Helper.lastDates(datesAll, 3);
