...
//--------------------------------------
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.Button7:
                String inp = Helper.multipleSpacetoSingleSpace("go  there");
                new AlertDialog.Builder(context).setMessage(Helper.multipleSpacetoSingleSpace(inp))
                        .create().show();
                break;
    ...
    void insertReportAdmin() {
      //  boolean succ = DAO.insertReport(context, db, DataPump.getReportModelList(), "schID");
