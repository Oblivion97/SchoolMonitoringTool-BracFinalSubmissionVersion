...
import com.example.f.schMon.view.attendance.SchoolListActivityAttnd;
...
public class NavDrawer {
    public static void navDrawerBtnsClick(final Context context, Toolbar toolbar) {
        ...
        if (userM.getFirstName() == null && userM.getMiddleName() == null && userM.getLastName() == null)
            userName.setText("Name: " + Helper.toCamelCase(userM.getUsername()).replaceAll("_", " "));
        else if (userM.getFirstName() != null && userM.getLastName() != null)
            userName.setText("Name: " + Helper.toCamelCase(userM.getFirstName() + " " + userM.getLastName()));
        else
            userName.setText("Name: " + Helper.toCamelCase(userM.getFirstName() + " " + userM.getMiddleName() + " " + userM.getLastName()));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                } else if (id == R.id.Ebarta) {
                    try {
                        String appToOpenPackageName = "com.brac.bracebatra";
                        intent = context.getPackageManager().getLaunchIntentForPackage(appToOpenPackageName);
                        appCompatActivity.startActivity(intent);
                        appCompatActivity.overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
                    } catch (Exception e) {
                        Toasty.warning(context, "Install E Barta").show();
                    }

                } else if (id == R.id.Attendance) {
                    intent = new Intent(context, SchoolListActivityAttnd.class);
                    appCompatActivity.startActivity(intent);
                    appCompatActivity.overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
                ...
                }else if (id==R.id.SolvedProblems){
