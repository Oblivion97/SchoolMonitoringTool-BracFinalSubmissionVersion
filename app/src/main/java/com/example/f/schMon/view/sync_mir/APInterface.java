...
public interface APInterface {
    ...
    Call<RepAList> getLastReport(@Query("uname") String u, @Query("passw") String p);
    ...
    @GET("/rest/apps/infrastructure-question/category/list")
    Call<RepCategoryModelList> getReportCategory(@Query("uname") String u, @Query("passw") String p);


    @GET("/rest/apps/infrastructure-report/solve/list")
    Call<RepSlvMdlList> getSolvedReport(@Query("uname") String u, @Query("passw") String p
   ...
   /* @GET("/rest/apps/infrastructure-report/solve/list")
    ...
    Call<EvlAList> getLastEvaluation(@Query("uname") String u, @Query("passw") String p);
    ...
    @GET("/rest/apps/attendance-report/report")
    Call<AtttndDashMdlList> getAttendanceDashData(@Query("uname") String u, @Query("passw") String p);
}
