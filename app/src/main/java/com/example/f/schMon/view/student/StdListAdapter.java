...
public class StdListAdapter extends ArrayAdapter<Student> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Typeface codexUnicornFont = Typeface.createFromAsset(App.getAppContext().getAssets(), "fonts/codexunicornfont.ttf");
        ...
        nameTV.setText(Helper.toCamelCase(stdList[position].name));
        fatherTV.setText("Father: " + Helper.toCamelCase(stdList[position].father));
