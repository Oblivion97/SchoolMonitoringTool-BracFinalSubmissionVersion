...
public class SchoolListActivityAttnd extends AppCompatActivity implements
        DialogDateAttdce.DialogDateAttdce_StartEval, DatePickerFragment.DateDialogListner {
    private final String TAG = SchoolListActivityAttnd.class.getName();
    private final Context context = SchoolListActivityAttnd.this;
    ...
    private SchoolListAdapterAttnd adapter;
...
/*___________________End option menu________________________________________________________*/
    ...
    public void onSyncComplete(MessageEvent e) {
        ...
        if (e.success == true) {
            Helper.restartActivity(context);
        }
    }
    ...
    public void onStartEvalClick(String schID, String gradeID, String date, String attendance) {
        ...
        if (!dateInputted || attendance.equals("")) {
            ...
            intent.putExtra(Global.openedFromWhichActivity, SchoolListActivityAttnd.class.getName());
    ...
    class LoadData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String strings) {
            ...
            schoolListRV.setAdapter(new SchoolListAdapterAttnd(context, schList, toOpenWhichActivity));
            pb.setVisibility(View.GONE);
