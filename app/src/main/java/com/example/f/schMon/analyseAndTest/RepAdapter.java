...
import com.example.f.schMon.view.report.RepDialog;
...
public class RepAdapter extends ArrayAdapter<RepMdlin> {
    ...
    public View getView(final int i, View cv, ViewGroup parent) {
        if (cv == null) {
            ...
            cv = vi.inflate(R.layout.row_report, parent, false);
        ...
        //font
        // Helper.setFont(context,new View[]{h.questionTV, h.probStatusTV, h.priorityTV, h.detailsTV});
        ...
        /*if (data.getAnswer() != null) {
            ...
            if (data.getAnswer().equals("1")) {
                ...
                h.priorityTV.setText("Problem Priority: " + Helper.problemPriorityNumToText(data));
                h.priorityTV.setTextColor(Helper.problemPriorityColor(context, data));
