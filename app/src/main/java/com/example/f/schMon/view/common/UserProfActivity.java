...
//___________________Start option menu______________________________________
    ...
    protected void onResume() {
        ...
        if (userM != null) {
            if (userM.getFirstName() == null && userM.getMiddleName() == null && userM.getLastName() == null)
                nameTV.setText("Name: " + Helper.toCamelCase(userM.getUsername()).replaceAll("_", " "));
            else if (userM.getFirstName() != null && userM.getLastName() != null)
                nameTV.setText("Name: " + Helper.toCamelCase(userM.getFirstName() + " " + userM.getLastName()));
            else
                nameTV.setText("Name: " + Helper.toCamelCase(userM.getFirstName() + " " + userM.getMiddleName() + " " + userM.getLastName()));

            if (userM.getGender() != null)
                if (userM.getGender().equals("M"))
                    genderTV.setText(Helper.toCamelCase("Gender: Male"));
                else genderTV.setText(Helper.toCamelCase("Gender: Female"));
            if (userM.getId() != null)
                idTV.setText(Helper.toCamelCase("ID: " + userM.getId()));
            if (userM.getGradeName() != null)
                desigTV.setText(Helper.toCamelCase("Designation: " + userM.getRoleName()));
            if (userM.getMobileNumber() != null)
                mobileTV.setText(Helper.toCamelCase("Mobile: " + userM.getMobileNumber()));
            if (userM.getPresentAddress() != null)
                addTV.setText(Helper.toCamelCase("Address: " + userM.getPresentAddress()));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (getSupportActionBar() != null)
        ...
        Helper.setFont(context, new View[]{title, nameTV, genderTV, idTV, desigTV, mobileTV, addTV,});
