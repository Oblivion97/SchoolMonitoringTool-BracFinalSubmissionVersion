...
package com.example.f.schMon.view.previous_log.logEval;
...
public class LogEvalAdapter extends ArrayAdapter<List<EvlModelin>> {
    ...
    public View getView(final int i, View convertView, ViewGroup parent) {
        ...
        school = Helper.getSchoolByIDFromList(schoolList, schID);
    ...
    void onClickView(int i) {
        synced = Helper.isEvaluationOfThisSchoolSynced(listList.get(i));
