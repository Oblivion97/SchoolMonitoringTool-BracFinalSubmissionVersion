...
public class RepDialog extends DialogFragment {
    ...
    View repDetailsContainer, repPriorityAndDateContainer;
    Button submitBtn;
    ImageView targetIV;
    Bundle bundle;
...
*/
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        repDetailsContainer = view.findViewById(R.id.repNoContainer);
        repPriorityAndDateContainer = view.findViewById(R.id.repPriorityAndDateContainer);
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                repDetailsContainer.setVisibility(View.VISIBLE);
                repPriorityAndDateContainer.setVisibility(View.GONE);
                detailsET.setHint("Enter any comment or note...");
                detailsET.setText(null);
                radioGroupPriority.clearCheck();
                problem = "yes";
            }
        ...
        no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                repDetailsContainer.setVisibility(View.VISIBLE);
                repPriorityAndDateContainer.setVisibility(View.VISIBLE);
                detailsET.setHint("Enter problem details...");
                detailsET.setText(null);
                problem = "no";
            }
        });
    ...
    private void setData() {
        ...
        if (data.getAnswer() == null)
            repDetailsContainer.setVisibility(View.GONE);
        /**answered*/
        else {
            if (data.getAnswer().equals("1")) {
                /**when answered is yes*/
                problem = "yes";
                detailsET.setText(data.getYesComment());
                repPriorityAndDateContainer.setVisibility(View.GONE);
                //repDetailsContainer.setVisibility(View.GONE);
                yes.setChecked(true);
            }
    ...
    private void yesRepMake(RepMdlin in) {
        ...
        // in.setPriority(null);
        in.setDetails(null);
        in.setYesComment(detailsET.getText().toString());
        in.setDateReport(dateRep);
        in.setSynced("0");
        in.setTimeLm(time_lm);
        if (in.getLocalIDAns() == null)
            in.setLocalIDAns(Helper.generateUniqueID("admin-ans"));
    }
