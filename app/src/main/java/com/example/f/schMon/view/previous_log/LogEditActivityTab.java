...
package com.example.f.schMon.view.previous_log;
...
import com.example.f.schMon.view.previous_log.logEval.LogEvalFrag;
import com.example.f.schMon.view.previous_log.logRep.LogRepFrag;
...
// __________ nav drawer close on back button click ____________________
    ...
    public void setViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(LogRepFrag.newInstance("", ""), "Environment Log");
        viewPagerAdapter.addFragment(LogEvalFrag.newInstance("", ""), "Academic Log");
