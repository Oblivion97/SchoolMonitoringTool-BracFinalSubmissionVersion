...
//___________________start option menu______________________________________
    ...
    protected void onResume() {
        ...
        month = "January";
        Log.d(TAG, String.valueOf(Helper.getPreviousMonth()));
        year = df6.format(new Date(System.currentTimeMillis()));
        year = "2017";
        monthMap = getMonthMap();


        year = String.valueOf(Helper.getPreviousMonth()[1]);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Helper.setFont(context, new View[]{infoTV, noDataTV});
        ...
        spinnerMonth.setOnItemSelectedListener(
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                        ...
                        //month = String.valueOf(Helper.getPreviousMonth()[0]);
        ...
        spinnerMonth.setSelection(Helper.getPreviousMonth()[0]);
